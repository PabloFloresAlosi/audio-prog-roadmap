...
Functions are used to simulate gameplay and audio-related logic:

Calculating sound parameters (volume, intensity)
Triggering audio events
Processing gameplay input values
...
Breaking problems into functions is essential for real-world systems
...
In Unreal Engine, almost everything is function-driven:
